// Logica di funzionamento della funzione di toggling
...
if ('serviceWorker' in navigator) {
    // registriamo il service worker e trattiamo
    // la promise di risposta
    navigator.serviceWorker.register('/sw.js')
        .then(function () {
            console.log('il service worker è registrato')
        })
